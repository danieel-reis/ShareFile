...
public class HandleConnection implements Runnable {
    ...
    @Override
    public void run() {
//        MainWindown.appendText("Manipulando a conexão...");
        try {
            ...
            if (typeRequest.equals(REQUEST_TYPE_EXPORT_TO_SERVER) || typeRequest.equals(REQUEST_TYPE_EXPORT_TO_SERVER_ALL)) {
                MainWindown.appendText("Ação: Exportar para servidor");
                ...
                MainWindown.appendText("Ação: Importar do servidor");
                ...
                if (file.exists()) {
                    ...
                    MainWindown.appendText("Arquivo enviado: " + file.getCanonicalPath());

                } else {
                    MainWindown.appendText("Erro ao enviar: " + file.getCanonicalPath());
                }

            } else if (typeRequest.equals(REQUEST_TYPE_IMPORT_LIST_FILES_FROM_SERVER)) {
                MainWindown.appendText("Ação: Lista de arquivos do servidor");
